...
function getAllData() {
  ...
  // GETS DAYS
    ...
    const formattedOne = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(today, 'd. M.');

    const dayAfter = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(today, 1);
    const formattedTwo = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(dayAfter, 'd. M.');

    const anotherDayAfter = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(today, 2);
    const formattedThree = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(anotherDayAfter, 'd. M.');
  ...
  function getHourly(weatherData) {
    ...
    // last update time
    const parsedTime = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(lastUpdateSeparated[1], 'HH:mm', new Date());

    // last update hour
    const currentHour = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(parsedTime);
    ...
    // card time part
      ...
      const differentFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(dataParts[1], 'HH:mm', new Date());
      const differentFormatFinal = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(differentFormat, 'hh:mm a');
    ...
    for (let i = 0; i < availableHourCardsTomorrow.length; i++) {
      ...
      const differentFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(twoParts[1], 'HH:mm', new Date());
      const differentFormatFinal = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(differentFormat, 'hh:mm a');
  ...
  function getTheIcon(text, sunsetHour, sunriseHour, currentTime) {
    ...
    if (sunriseHour !== null && sunsetHour !== null) {
      const time1 = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(currentTime, 'hh:mm a', new Date());
      const time2 = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(sunriseHour, 'hh:mm a', new Date());
      const time3 = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(sunsetHour, 'hh:mm a', new Date());
      const comparison = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(time1, time2);
      const comparison2 = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(time1, time3);
      if (comparison <= 0) {
        folder = 'night';
      }
    ...
    Promise.all(weatherDataPromises)
      .then((weatherDataArray) => {
        for (let i = 0; i < weatherDataArray.length; i++) {
          ...
          const updateFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(updateParts[1], 'HH:mm', new Date());
          const differentFormat = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(updateFormat, 'hh:mm a');
          setDomIcon(cardIcon, iconText, sunset, sunrise, differentFormat);
        }
        desktopCheckbox.checked ? (0,_dom__WEBPACK_IMPORTED_MODULE_0__.handleFahrenheit)() : null;
      })
      .catch((error) => {
        alert('Error:', error);
      });
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   handleCelsius: () => (/* binding */ handleCelsius),
/* harmony export */   handleFahrenheit: () => (/* binding */ handleFahrenheit)
/* harmony export */ });
