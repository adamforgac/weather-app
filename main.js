...
function getAllData() {
  ...
  function getSetup(weatherData) {
    ...
    const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(currentDate, 'dd. M. yyyy');
    const dayName = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(currentDate, 'iiii');
